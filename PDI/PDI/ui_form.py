...
"border-radius: 10px;")
        ...
        icon = QIcon()
        icon.addFile(u"Images/download.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border-radius: 20px;")
        ...
        self.label.setPixmap(QPixmap(u"Images/medicina-logo-886CC8F59D-seeklogo.com.png"))
        ...
        icon2 = QIcon()
        icon2.addFile(u"Images/Pesssoas.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"Images/57108.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pontos.setAutoFillBackground(True)
        icon4 = QIcon()
        icon4.addFile(u"Images/3pontos.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pontos.setIcon(icon4)
