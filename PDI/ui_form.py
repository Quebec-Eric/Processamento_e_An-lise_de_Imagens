...
"border-radius: 20px;")
        ...
        icon2 = QIcon()
        icon2.addFile(u"App/Imagens/Pesssoas.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"App/Imagens/57108.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"App/Imagens/3pontos.png", QSize(), QIcon.Normal, QIcon.Off)
