...
"border-radius: 10px;")
        ...
        self.Salvar.setGeometry(QRect(90, 0, 61, 31))
        ...
        self.toolButton.setGeometry(QRect(10, -11, 50, 50))
        icon1 = QIcon()
        icon1.addFile(u"App/Imagens/Pasta.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButton.setIcon(icon1)
        self.toolButton.setIconSize(QSize(100, 100))
        self.toolButton.setAutoRaise(True)
        self.IA = QToolButton(self.centralwidget)
        self.IA.setObjectName(u"IA")
        self.IA.setGeometry(QRect(180, 3, 41, 31))
        icon2 = QIcon()
        icon2.addFile(u"App/Imagens/IAFoto.png", QSize(), QIcon.Normal, QIcon.Off)
        self.IA.setIcon(icon2)
        self.IA.setIconSize(QSize(41, 35))
        self.IA.setAutoRepeat(False)
...
"border-radius: 20px;")
        ...
        icon3 = QIcon()
        icon3.addFile(u"App/Imagens/Pesssoas.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Colaboradores.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"App/Imagens/57108.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Funcionamento.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u"App/Imagens/3pontos.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pontos.setIcon(icon5)
